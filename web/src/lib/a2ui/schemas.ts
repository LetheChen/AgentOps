...
import { AGENTOPS_VIEW_SPEC_VERSION } from "./view-spec.js";
...
export const agentopsViewNodeSchema = {
  $id: "agentops-view-node-v1",
  type: "object",
  properties: {
    id: identifier,
    ...
    children: { type: "array", minItems: 1, maxItems: 24, items: { $ref: "agentops-view-node-v1" } },
    item: { $ref: "agentops-view-node-v1" },
    ...
    title: { $ref: "agentops-view-value-v1" },
    text: { $ref: "agentops-view-value-v1" },
    label: { $ref: "agentops-view-value-v1" },
    value: { $ref: "agentops-view-value-v1" },
    unit: { $ref: "agentops-view-value-v1" },
    uri: { $ref: "agentops-view-value-v1" },
    description: { $ref: "agentops-view-value-v1" },
    alt: { $ref: "agentops-view-value-v1" },
...
export const agentopsViewSpecSchema = {
  $id: "agentops-view-spec-v1",
  type: "object",
  properties: {
    view_version: { const: AGENTOPS_VIEW_SPEC_VERSION },
    root: { $ref: "agentops-view-node-v1" },
  },
...
export const agentopsA2uiDataBindingSchema = {
  $id: "agentops-a2ui-data-binding-v1",
  type: "object",
...
const dynamicValueRef = { $ref: "agentops-a2ui-dynamic-value-v1" } as const;
const dynamicStringRef = { $ref: "agentops-a2ui-dynamic-string-v1" } as const;
const dynamicNumberRef = { $ref: "agentops-a2ui-dynamic-number-v1" } as const;
const dynamicBooleanRef = { $ref: "agentops-a2ui-dynamic-boolean-v1" } as const;
...
export const agentopsA2uiFunctionCallSchema = {
  $id: "agentops-a2ui-function-call-v1",
  oneOf: [
    ...
    functionVariant("and", {
      values: { type: "array", minItems: 2, maxItems: AGENTOPS_A2UI_MAX_DIRECT_CHILDREN, items: dynamicBooleanRef },
    }, ["values"]),
    functionVariant("or", {
      values: { type: "array", minItems: 2, maxItems: AGENTOPS_A2UI_MAX_DIRECT_CHILDREN, items: dynamicBooleanRef },
    }, ["values"]),
...
function catalogCompatibleSchema(value: unknown): unknown {
  ...
  return Object.fromEntries(Object.entries(record).map(([key, entry]) => {
    ...
    const commonType = {
      "agentops-a2ui-data-binding-v1": "DataBinding",
      "agentops-a2ui-dynamic-value-v1": "DynamicValue",
      "agentops-a2ui-dynamic-string-v1": "DynamicString",
      "agentops-a2ui-dynamic-number-v1": "DynamicNumber",
      "agentops-a2ui-dynamic-boolean-v1": "DynamicBoolean",
      "agentops-a2ui-child-list-v1": "ChildList",
      "agentops-a2ui-action-v1": "Action",
    }[entry];
...
export const agentopsA2uiCatalogFunctionSchemas = Object.fromEntries(
  agentopsA2uiFunctionCallSchema.oneOf
...
export const agentopsA2uiDynamicValueSchema = {
  $id: "agentops-a2ui-dynamic-value-v1",
  oneOf: [
    { type: "string" },
    { type: "number" },
    { type: "boolean" },
    { type: "array" },
    { $ref: "agentops-a2ui-data-binding-v1" },
    { $ref: "agentops-a2ui-function-call-v1" },
  ],
} as const;

export const agentopsA2uiDynamicStringSchema = {
  $id: "agentops-a2ui-dynamic-string-v1",
  oneOf: [
    a2uiShortString,
    { $ref: "agentops-a2ui-data-binding-v1" },
    { $ref: "agentops-a2ui-function-call-v1" },
...
export const agentopsA2uiDynamicNumberSchema = {
  $id: "agentops-a2ui-dynamic-number-v1",
  oneOf: [
    { type: "number" },
    { $ref: "agentops-a2ui-data-binding-v1" },
    { $ref: "agentops-a2ui-function-call-v1" },
...
export const agentopsA2uiDynamicBooleanSchema = {
  $id: "agentops-a2ui-dynamic-boolean-v1",
  oneOf: [
    { type: "boolean" },
    { $ref: "agentops-a2ui-data-binding-v1" },
    { $ref: "agentops-a2ui-function-call-v1" },
...
export const agentopsA2uiChildListSchema = {
  $id: "agentops-a2ui-child-list-v1",
  oneOf: [
    {
      type: "array",
      maxItems: AGENTOPS_A2UI_MAX_DIRECT_CHILDREN,
      items: identifier,
    },
    {
      type: "object",
...
export const agentopsA2uiActionSchema = {
  $id: "agentops-a2ui-action-v1",
  oneOf: [
    {
      type: "object",
      properties: {
    ...
    {
      type: "object",
      properties: { functionCall: { $ref: "agentops-a2ui-function-call-v1" } },
...
const a2uiChildrenRef = { $ref: "agentops-a2ui-child-list-v1" } as const;
const a2uiSourceRef = { $ref: "agentops-a2ui-data-binding-v1" } as const;
const a2uiChecks = {
  type: "array",
  maxItems: AGENTOPS_A2UI_MAX_DIRECT_CHILDREN,
...
const basicComponentSchemas = [
  ...
  componentSchema("Button", {
    ...
    action: { $ref: "agentops-a2ui-action-v1" },
  ...
  componentSchema("ChoicePicker", {
    ...
    options: {
      type: "array",
      maxItems: AGENTOPS_A2UI_MAX_SOURCE_ITEMS,
      items: {
        type: "object",
...
const maxItemsSchema = { type: "integer", minimum: 1, maximum: AGENTOPS_A2UI_MAX_SOURCE_ITEMS } as const;
...
const agentopsComponentSchemas = [
  componentSchema("AoGrid", {
    children: a2uiChildrenRef,
    columns: gridColumnsSchema,
    gap: gapSchema,
    align: alignSchema,
  }, ["children", "columns"]),
  componentSchema("AoGridItem", {
    child: identifier,
    span: { type: "integer", minimum: 1, maximum: 3 },
  }, ["child", "span"]),
  componentSchema("AoSection", {
    title: dynamicStringRef,
    children: a2uiChildrenRef,
    tone: a2uiTone,
  }, ["children"]),
  componentSchema("AoMetric", {
    label: dynamicStringRef,
    value: dynamicValueRef,
    unit: dynamicStringRef,
    tone: a2uiTone,
  }, ["label", "value"]),
  componentSchema("AoStatusBadge", { text: dynamicStringRef, tone: a2uiTone }, ["text"]),
  componentSchema("AoProgress", {
    label: dynamicStringRef,
    value: dynamicNumberRef,
    tone: a2uiTone,
  }, ["value"]),
  componentSchema("AoStep", {
  ...
  componentSchema("AoTable", {
    ...sourceProperties,
    columns: { type: "array", minItems: 1, maxItems: AGENTOPS_A2UI_MAX_DIRECT_CHILDREN, items: tableColumnSchema },
  }, ["source", "columns"]),
  componentSchema("AoTimeline", {
    ...sourceProperties,
    itemTitlePath: a2uiItemPointer,
    itemDetailPath: a2uiItemPointer,
  ...
  componentSchema("AoBarChart", {
    ...sourceProperties,
    itemLabelPath: a2uiItemPointer,
    itemValuePath: a2uiItemPointer,
    itemTonePath: a2uiItemPointer,
  }, ["source", "itemLabelPath", "itemValuePath"]),
  componentSchema("AoLineChart", {
    ...sourceProperties,
    xAxis: { type: "object", properties: { path: { type: "string" } }, required: ["path"], additionalProperties: false },
    seriesNamePath: a2uiItemPointer,
    seriesDataPath: a2uiItemPointer,
    unit: dynamicStringRef,
  }, ["source", "xAxis", "seriesNamePath", "seriesDataPath"]),
  componentSchema("AoPieChart", {
    ...sourceProperties,
    itemLabelPath: a2uiItemPointer,
    itemValuePath: a2uiItemPointer,
    unit: dynamicStringRef,
  }, ["source", "itemLabelPath", "itemValuePath"]),
  componentSchema("AoDag", {
    ...sourceProperties,
  ...
  componentSchema("AoDisclosure", {
    title: dynamicStringRef,
    children: a2uiChildrenRef,
    open: dynamicBooleanRef,
  }, ["title", "children"]),
  componentSchema("AoLink", {
    label: dynamicStringRef,
    url: dynamicStringRef,
    description: dynamicStringRef,
  }, ["label", "url"]),
  componentSchema("AoArtifact", {
    kind: { type: "string", enum: ["image", "html", "file"] },
...
const componentDescriptions: Readonly<Record<string, string>> = {
  AoGrid: "Responsive one-to-three column layout for a compact AgentOps Block.",
  AoGridItem: "One child placed in a bounded span of a AgentOps grid.",
  AoSection: "A titled semantic section with an optional status tone.",
  AoMetric: "A compact label, value, and optional unit for scannable facts.",
  AoStatusBadge: "A short status label using AgentOps semantic tones.",
  AoProgress: "A bounded zero-to-one-hundred progress indicator.",
  AoStep: "One ordered step with a connected marker and arbitrary rich child content.",
  AoList: "A dense data-bound list rendered without expanding a component template.",
  AoTable: "A compact data-bound table with typed column formatting.",
  AoTimeline: "A chronological data-bound sequence of events or steps.",
  AoBarChart: "A compact categorical bar chart for numeric comparisons.",
  AoLineChart: "A compact line chart for trend visualization with multiple series.",
  AoPieChart: "A compact pie chart for proportional distribution.",
  AoDag: "A compact dependency graph for plans and execution state.",
  AoDisclosure: "A summary that reveals secondary detail on demand.",
  AoLink: "A labelled, credential-free HTTP(S) reference that opens outside AgentOps.",
  AoArtifact: "A passive preview reference to a AgentOps-published image, HTML page, or file.",
  AoIf: "Conditionally renders children from a deterministic boolean binding.",
};
...
export const agentopsA2uiCatalogComponentSchemas = Object.fromEntries(
  [...basicComponentSchemas, ...agentopsComponentSchemas]
    .map((schema) => catalogComponentEntry(schema as Record<string, unknown>)),
) as Readonly<Record<string, Record<string, unknown>>>;

export const agentopsA2uiComponentSchema = {
  $id: "agentops-a2ui-component-v1",
  oneOf: [...basicComponentSchemas, ...agentopsComponentSchemas],
} as const;

export const agentopsA2uiSurfacePropertiesSchema = {
  $id: "agentops-a2ui-surface-properties-v1",
  type: "object",
  properties: {
...
export const agentopsA2uiCatalogDefinition = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: AGENTOPS_A2UI_CATALOG_ID,
  title: "AgentOps A2UI Core Catalog",
  description: "A2UI v1.0 Basic components plus bounded AgentOps components for dense, responsive agent interfaces.",
  catalogId: AGENTOPS_A2UI_CATALOG_ID,
  instructions: [
    "Use a flat A2UI component graph with exactly one root component.",
    "Prefer one coherent Block per user intent and use AgentOps components for metrics, status, progress, lists, tables, timelines, charts, DAGs, disclosures, safe source links, and published artifacts.",
    "Use only semantic tones and bounded grid spans; do not emit HTML, CSS, JavaScript, coordinates, or arbitrary style values.",
    "Action events must target host-registered AgentOps actions. The AgentOps host rejects local function actions, event context, response paths, and response requests.",
  ].join("\n\n"),
  $defs: {
    surfaceProperties: Object.fromEntries(Object.entries(agentopsA2uiSurfacePropertiesSchema)
      .filter(([name]) => name !== "$id")),
    anyComponent: {
      oneOf: Object.keys(agentopsA2uiCatalogComponentSchemas)
        .map((name) => ({ $ref: `#/components/${name}` })),
    },
    anyFunction: {
      oneOf: Object.keys(agentopsA2uiCatalogFunctionSchemas)
        .map((name) => ({ $ref: `#/functions/${name}` })),
    },
  },
  components: agentopsA2uiCatalogComponentSchemas,
  functions: agentopsA2uiCatalogFunctionSchemas,
} as const;

export const agentopsA2uiSurfaceSchema = {
  $id: "agentops-a2ui-surface-v1",
  type: "object",
  properties: {
    version: { const: AGENTOPS_A2UI_VERSION },
    catalogId: { const: AGENTOPS_A2UI_CATALOG_ID },
    components: {
      type: "array",
      minItems: 1,
      maxItems: AGENTOPS_A2UI_MAX_COMPONENTS,
      items: { $ref: "agentops-a2ui-component-v1" },
    },
    surfaceProperties: { $ref: "agentops-a2ui-surface-properties-v1" },
  },
  required: ["version", "catalogId", "components"],
  additionalProperties: false,
} as const;

export const agentopsA2uiCreateSurfaceMessageSchema = {
  $id: "agentops-a2ui-create-surface-message-v1",
  type: "object",
  properties: {
    version: { const: AGENTOPS_A2UI_VERSION },
    createSurface: {
...
const nodeProperties = {
  ...
  view: { $ref: "agentops-view-spec-v1" },
  a2ui: { $ref: "agentops-a2ui-surface-v1" },
...
export const generativeUiSchemas: Record<string, Record<string, unknown>> = {
  "agentops-view-value-v1": viewValueSchema as Record<string, unknown>,
  "agentops-view-node-v1": agentopsViewNodeSchema as Record<string, unknown>,
  "agentops-view-spec-v1": agentopsViewSpecSchema as Record<string, unknown>,
  "agentops-a2ui-data-binding-v1": agentopsA2uiDataBindingSchema as Record<string, unknown>,
  "agentops-a2ui-function-call-v1": agentopsA2uiFunctionCallSchema as Record<string, unknown>,
  "agentops-a2ui-dynamic-value-v1": agentopsA2uiDynamicValueSchema as Record<string, unknown>,
  "agentops-a2ui-dynamic-string-v1": agentopsA2uiDynamicStringSchema as Record<string, unknown>,
  "agentops-a2ui-dynamic-number-v1": agentopsA2uiDynamicNumberSchema as Record<string, unknown>,
  "agentops-a2ui-dynamic-boolean-v1": agentopsA2uiDynamicBooleanSchema as Record<string, unknown>,
  "agentops-a2ui-child-list-v1": agentopsA2uiChildListSchema as Record<string, unknown>,
  "agentops-a2ui-action-v1": agentopsA2uiActionSchema as Record<string, unknown>,
  "agentops-a2ui-component-v1": agentopsA2uiComponentSchema as Record<string, unknown>,
  "agentops-a2ui-surface-properties-v1": agentopsA2uiSurfacePropertiesSchema as Record<string, unknown>,
  "agentops-a2ui-surface-v1": agentopsA2uiSurfaceSchema as Record<string, unknown>,
  "agentops-a2ui-create-surface-message-v1": agentopsA2uiCreateSurfaceMessageSchema as Record<string, unknown>,
