...
import type { AgentopsA2uiSurfaceV1 } from "./a2ui.js";
import type { AgentopsViewSpecV1 } from "./view-spec.js";
...
export interface GenerativeUiPluginRef {
  /** Reverse-DNS plugin id, for example com.agentops.core. */
  id: string;
  version: string;
}
...
> {
  ...
  id: string;
  /** Globally namespaced semantic kind, for example com.agentops.core/task_summary. */
  kind: string;
