...
/** Exact upstream revision used to define the AgentOps A2UI v1.0 catalog. */
export const AGENTOPS_A2UI_UPSTREAM_COMMIT = "16425ca82061f756e420d2453e066d0c7c0295c1" as const;
export const AGENTOPS_A2UI_VERSION = "v1.0" as const;
export const AGENTOPS_A2UI_CATALOG_ID = "https://agentops.dev/a2ui/catalogs/core/v1" as const;
export const AGENTOPS_A2UI_MAX_BYTES = 64 * 1024;
export const AGENTOPS_A2UI_MAX_DEPTH = 8;
export const AGENTOPS_A2UI_MAX_COMPONENTS = 128;
export const AGENTOPS_A2UI_MAX_DIRECT_CHILDREN = 24;
export const AGENTOPS_A2UI_MAX_SOURCE_ITEMS = 50;

export type A2uiVersionV1 = typeof AGENTOPS_A2UI_VERSION;
...
/**
 * Deterministic functions exposed by the AgentOps profile. `openUrl` and
 ...
 */
export const AGENTOPS_A2UI_PURE_FUNCTIONS = [
  "@index",
  "and",
  "email",
  "formatCurrency",
...
export type A2uiPureFunctionNameV1 = (typeof AGENTOPS_A2UI_PURE_FUNCTIONS)[number];

/** Standard A2UI FunctionCall shape, restricted to AgentOps's pure catalog. */
...
export type AgentopsA2uiGapV1 = "none" | "xs" | "sm" | "md" | "lg";
export type AgentopsA2uiAlignV1 = "start" | "center" | "end" | "stretch";
export type AgentopsA2uiToneNameV1 = "neutral" | "info" | "positive" | "warning" | "critical";
export type AgentopsA2uiToneV1 = AgentopsA2uiToneNameV1 | A2uiDataBindingV1 | A2uiFunctionCallV1;
export type AgentopsA2uiFormatV1 = "text" | "number" | "percent" | "datetime" | "duration" | "status" | "tone";

export interface AgentopsA2uiGridComponentV1 extends A2uiComponentCommonV1 {
  component: "AoGrid";
  children: A2uiChildListV1;
  columns: { default: 1 | 2 | 3; compact: 1 | 2 | 3 };
  gap?: AgentopsA2uiGapV1;
  align?: AgentopsA2uiAlignV1;
}

export interface AgentopsA2uiGridItemComponentV1 extends A2uiComponentCommonV1 {
  component: "AoGridItem";
  child: string;
  span: 1 | 2 | 3;
}

export interface AgentopsA2uiSectionComponentV1 extends A2uiComponentCommonV1 {
  component: "AoSection";
  title?: A2uiDynamicStringV1;
  children: A2uiChildListV1;
  tone?: AgentopsA2uiToneV1;
}

export interface AgentopsA2uiMetricComponentV1 extends A2uiComponentCommonV1 {
  component: "AoMetric";
  label: A2uiDynamicStringV1;
...
export interface AgentopsA2uiStatusBadgeComponentV1 extends A2uiComponentCommonV1 {
  component: "AoStatusBadge";
  text: A2uiDynamicStringV1;
  tone?: AgentopsA2uiToneV1;
}

export interface AgentopsA2uiProgressComponentV1 extends A2uiComponentCommonV1 {
...
export interface AgentopsA2uiStepComponentV1 extends A2uiComponentCommonV1 {
  component: "AoStep";
...
interface AgentopsA2uiSourceComponentV1 extends A2uiComponentCommonV1 {
  source: A2uiDataBindingV1;
  maxItems?: number;
}

export interface AgentopsA2uiListComponentV1 extends AgentopsA2uiSourceComponentV1 {
  component: "AoList";
...
export interface AgentopsA2uiTimelineComponentV1 extends AgentopsA2uiSourceComponentV1 {
  component: "AoTimeline";
  itemTitlePath: string;
  itemDetailPath?: string;
  itemTimePath?: string;
  itemStatusPath?: string;
...
export interface AgentopsA2uiBarChartComponentV1 extends AgentopsA2uiSourceComponentV1 {
...
export interface AgentopsA2uiDagComponentV1 extends AgentopsA2uiSourceComponentV1 {
  component: "AoDag";
  itemIdPath: string;
  itemLabelPath: string;
  itemDetailPath?: string;
...
export interface AgentopsA2uiTableComponentV1 extends AgentopsA2uiSourceComponentV1 {
  component: "AoTable";
  columns: Array<{
    id: string;
    label: string;
    path: string;
    format?: AgentopsA2uiFormatV1;
  }>;
}

export interface AgentopsA2uiDisclosureComponentV1 extends A2uiComponentCommonV1 {
  component: "AoDisclosure";
  title: A2uiDynamicStringV1;
  children: A2uiChildListV1;
  open?: A2uiDynamicBooleanV1;
}

export interface AgentopsA2uiLinkComponentV1 extends A2uiComponentCommonV1 {
  component: "AoLink";
  label: A2uiDynamicStringV1;
  url: A2uiDynamicStringV1;
  description?: A2uiDynamicStringV1;
...
export interface AgentopsA2uiArtifactComponentV1 extends A2uiComponentCommonV1 {
  component: "AoArtifact";
...
export interface AgentopsA2uiIfComponentV1 extends A2uiComponentCommonV1 {
  component: "AoIf";
  condition: A2uiDynamicBooleanV1;
  children: A2uiChildListV1;
}
...
export type AgentopsA2uiCatalogComponentV1 =
  | AgentopsA2uiGridComponentV1
  | AgentopsA2uiGridItemComponentV1
  | AgentopsA2uiSectionComponentV1
  | AgentopsA2uiMetricComponentV1
  | AgentopsA2uiStatusBadgeComponentV1
  | AgentopsA2uiProgressComponentV1
  | AgentopsA2uiStepComponentV1
  | AgentopsA2uiListComponentV1
  | AgentopsA2uiTableComponentV1
  | AgentopsA2uiTimelineComponentV1
  | AgentopsA2uiBarChartComponentV1
  | AgentopsA2uiDagComponentV1
  | AgentopsA2uiDisclosureComponentV1
  | AgentopsA2uiLinkComponentV1
  | AgentopsA2uiArtifactComponentV1
  | AgentopsA2uiIfComponentV1;

export type A2uiComponentV1 = A2uiBasicComponentV1 | AgentopsA2uiCatalogComponentV1;

export interface AgentopsA2uiSurfacePropertiesV1 {
  iconUrl?: string;
  agentDisplayName?: string;
}

export interface AgentopsA2uiSurfaceV1 {
  version: A2uiVersionV1;
  catalogId: typeof AGENTOPS_A2UI_CATALOG_ID;
  components: A2uiComponentV1[];
  surfaceProperties?: AgentopsA2uiSurfacePropertiesV1;
}

/** Exact standard v1.0 createSurface envelope, before AgentOps narrows it. */
...
/** Standard A2UI v1.0 createSurface message specialized to a direct AgentOps surface. */
export interface AgentopsA2uiCreateSurfaceMessageV1 extends A2uiCreateSurfaceMessageV1 {
  createSurface: {
    surfaceId: string;
    catalogId: typeof AGENTOPS_A2UI_CATALOG_ID;
    surfaceProperties?: AgentopsA2uiSurfacePropertiesV1;
...
export interface AgentopsA2uiSemanticIssueV1 {
  path: string;
  message: string;
  keyword: string;
}

export interface AgentopsA2uiSemanticOptionsV1 {
...
const PURE_FUNCTIONS = new Set<string>(AGENTOPS_A2UI_PURE_FUNCTIONS);
...
/**
 * Performs AgentOps semantic checks that JSON Schema cannot express: graph
 * integrity, materialization budgets, binding scope, Actions and URI safety.
 */
export function analyzeAgentopsA2uiSurfaceSemantics(
  surface: AgentopsA2uiSurfaceV1,
  options: AgentopsA2uiSemanticOptionsV1 = {},
): AgentopsA2uiSemanticIssueV1[] {
  const prefix = options.path ?? "";
  const issues: AgentopsA2uiSemanticIssueV1[] = [];
  ...
  if (surface.catalogId !== AGENTOPS_A2UI_CATALOG_ID) {
    issue("/catalogId", `catalogId must be ${AGENTOPS_A2UI_CATALOG_ID}`, "a2uiCatalogId");
  }
  if (surface.components.length > AGENTOPS_A2UI_MAX_COMPONENTS) {
    issue(
      "/components",
      `declared component count exceeds ${AGENTOPS_A2UI_MAX_COMPONENTS}`,
  ...
  for (const [id, entry] of components) {
    ...
    if (directChildren > AGENTOPS_A2UI_MAX_DIRECT_CHILDREN) {
      issue(
        `/components/${entry.index}`,
        `direct child count exceeds ${AGENTOPS_A2UI_MAX_DIRECT_CHILDREN}`,
  ...
  const checkDepth = (id: string, depth: number, ancestors: ReadonlySet<string>): void => {
    ...
    if (depth > AGENTOPS_A2UI_MAX_DEPTH) {
      const index = components.get(id)?.index ?? 0;
      issue(
        `/components/${index}`,
        `component depth exceeds ${AGENTOPS_A2UI_MAX_DEPTH}`,
        "maxA2uiDepth",
      );
      return;
    }
  ...
  const validateDynamic = (
    ...
    if (isFunctionCall(value)) {
      if (!PURE_FUNCTIONS.has(value.call)) {
        issue(`${path}/call`, `function is not in the pure AgentOps catalog: ${value.call}`, "a2uiPureFunction");
      }
  ...
  const validateAction = (action: A2uiActionV1, index: number, scope: EvaluationScope): void => {
    ...
    if (Object.prototype.hasOwnProperty.call(action.event, "responsePath")) {
      issue(
        ...
        "responsePath is not supported by the AgentOps host",
        "a2uiResponsePath",
      );
    ...
    if (Object.keys(action.event.context ?? {}).length > 0) {
      issue(
        `${path}/event/context`,
        "non-empty event.context is not supported by the AgentOps host",
        "a2uiActionContext",
      );
    }
  ...
  const validateComponentDynamics = (
    ...
    if (component.component === "AoTable") {
    ...
    switch (component.component) {
      ...
      case "AoArtifact":
        ...
        break;
      case "AoIf": validateDynamic(component.condition, `${base}/condition`, scope); break;
      default: break;
    }
  };
  ...
  if (!hasStructuralGraphError && components.has("root")) {
    ...
    const count = (amount: number, path: string): boolean => {
      materialized += amount;
      if (materialized <= AGENTOPS_A2UI_MAX_COMPONENTS) return true;
      if (!materializedExceeded) {
        materializedExceeded = true;
        issue(
          path,
          `materialized component count exceeds ${AGENTOPS_A2UI_MAX_COMPONENTS}`,
    ...
    const sourceItems = (sourcePath: string, path: string, scope: EvaluationScope): unknown[] | undefined => {
      ...
      if (source.length > AGENTOPS_A2UI_MAX_SOURCE_ITEMS) {
        issue(
          path,
          `source exceeds ${AGENTOPS_A2UI_MAX_SOURCE_ITEMS} items`,
          "maxA2uiSourceItems",
        );
      }
      return source.slice(0, AGENTOPS_A2UI_MAX_SOURCE_ITEMS);
    };
    ...
    const materialize = (id: string, scope: EvaluationScope): void => {
      ...
      if (component.component === "AoLink") validateExternalLink(component.url, `${base}/url`, scope);
      if (component.component === "AoArtifact") validateArtifact(component.uri, `${base}/uri`, scope);
      ...
      if (SOURCE_COMPONENTS.has(component.component) && "source" in component) {
        ...
        if (items) count(Math.min(items.length, component.maxItems ?? AGENTOPS_A2UI_MAX_SOURCE_ITEMS), base);
      }
      for (const edge of adjacency.get(id) ?? []) {
        ...
        if (edge.template) {
          ...
          if (items === undefined) {
            ...
            if (items.length > AGENTOPS_A2UI_MAX_DIRECT_CHILDREN) {
              issue(
                base,
                `materialized direct child count exceeds ${AGENTOPS_A2UI_MAX_DIRECT_CHILDREN}`,
                "maxA2uiDirectChildren",
              );
            }
 ...
 */
export function createAgentopsA2uiCreateSurfaceMessage(input: {
  id: string;
  content: Record<string, unknown>;
  a2ui: AgentopsA2uiSurfaceV1;
}): AgentopsA2uiCreateSurfaceMessageV1 {
  return {
    version: AGENTOPS_A2UI_VERSION,
    createSurface: {
      surfaceId: input.id,
